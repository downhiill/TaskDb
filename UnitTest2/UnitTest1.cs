...
namespace _1.UnitTest2
{
    public class UnitTest1
    {
        ...
        {
            // Arrange
            var user = new User { Id = 1, Name = "John", Age = 30, Wages = 1000 };
            _dbContext.Users.Add(user);
            _dbContext.SaveChanges();
        ...
        {
            // Arrange
            var user = new User { Id = 1, Name = "John", Age = 30, DateOfBirth = new DateTime(1991, 5, 1) };
            _dbContext.Users.Add(user);
            _dbContext.SaveChanges();
        ...
        public void SearchUsers_ShouldReturnUsersMatchingTerm()
        {
            ...
            var users = new List<User>
            {
                new User { Id = 1, Name = "John", Age = 30 },
                new User { Id = 2, Name = "Jane", Age = 25 },
                new User { Id = 3, Name = "Johnny", Age = 35 }
            };
            _dbContext.Users.AddRange(users);
            _dbContext.SaveChanges();
